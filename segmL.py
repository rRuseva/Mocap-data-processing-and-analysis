...
if __name__ == "__main__":
	...
	###	
	r_velocity, r_vel = t.hand_velocity(start_frame, end_frame, new_data, marker_list, 'L')
	...
	for i in range(0, count-1):
		...
		vel, vel_norm = t.hand_velocity(st+start_frame,en+start_frame,new_data, marker_list,'L')
